...
def main():
    ...
    if choice=="Pandas Profiling":
        ...
        if dfile is not None:
            sdf=pd.read_csv(dfile)
            st.subheader(" Head of Youre Dataset")
            st.write(sdf.head())
            report=sv.analyze(sdf)
        ...
        st.write(" A Handy tool to Analyze Csv Files [Click Here](https://share.streamlit.io/pratap517/streamlitapp_dataanalysis/main/main_app.py)")
        st.write(" A Simple loan Prediction App [Click Here](https://share.streamlit.io/pratap517/ml_deploy_using_streamlit/main/app.py)")
        st.write(" A Simple Mask Detection App [Click Here](https://mask-detection-5a800.firebaseapp.com/)")
		...
		<h1 style="color:black;text-align:center;">Simple EDA app with Streamlit Components</h1>
		</div>
		"""
        stc.html(html_temp)
        st.markdown("""
